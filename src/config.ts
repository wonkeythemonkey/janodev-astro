...
export const SITE: Site = {
  website: "https://janodev.com/", // replace this with your deployed domain
  author: "Jesse Janowiak",
  desc: "Articles, tutorials, links, and assorted writing by Jesse Janowiak.",
  title: "Jano[Dev]",
  ogImage: "assets/janodev-og.jpg",
...
export const SOCIALS: SocialObjects = [
  {
    name: "Mastodon",
    href: "https://mastodon.social/@wonkeythemonkey",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/jessejanowiak/",
    linkTitle: `${SITE.author} on LinkedIn`,
    active: true,
  },
  {
    name: "Mail",
    href: "mailto:jajanowiak@gmail.com",
